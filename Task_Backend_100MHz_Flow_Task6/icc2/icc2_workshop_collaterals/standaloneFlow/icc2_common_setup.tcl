...
set REFERENCE_LIBRARY 		[list /home/veeram/PD_task6/run1/icc2_workshop_collaterals/nangate_stdcell.lef /home/veeram/PD_task6/run1/icc2_workshop_collaterals/sram_32_1024_freepdk45.lef]	;# Required; a list of reference libraries for the design library.
...
#set VERILOG_NETLIST_FILES      "/home/nanodcmaster/Synopsys/pdk/SCL_PDK_3/PD_task6/run1/icc2_workshop_collaterals/pnrScripts/spi_slave.synth.v"
set VERILOG_NETLIST_FILES	"/home/veeram/PD_task6/run1/icc2_workshop_collaterals/pnrScripts/raven_wrapper.synth.v"	;# Verilog netlist files;
					;# 	for DP: required
...
set TECH_FILE 			"/home/veeram/PD_task6/run1/icc2_workshop_collaterals/nangate.tf" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
...
set LINK_LIBRARY		[list /home/veeram/PD_task6/run1/icc2_workshop_collaterals/nangate_typical.db /home/veeram/PD_task6/run1/icc2_workshop_collaterals/sram_32_1024_freepdk45_TT_1p0V_25C_lib.db]	;# Specify .db files;
